...
class FormatResultTest extends TestCase
{
    ...
    public function test_format_result_passes_order_type_to_calculate_fees()
    {
        ...
        // Calculate fees for taker
        $takerFees = $this->invokeMethod($analysisService, 'calculateFees', [1000, 'taker']);
        ...
        // Calculate fees for maker
        $makerFees = $this->invokeMethod($analysisService, 'calculateFees', [1000, 'maker']);
